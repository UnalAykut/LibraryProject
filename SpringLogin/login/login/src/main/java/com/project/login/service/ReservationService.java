...
public class ReservationService {
	...
	public ReservationService(ReservationDataPort reservationDataPort,JwtTokenProvider jwtTokenProvider) {
...
/*
 ...
 // Kullanıcının rezervasyon bilgilerini görmesi
    public List<ReservationResponseDto> getUserReservations(HttpServletRequest request) {
    	// Token'ı çöz ve kullanıcı ID'sini al
        String token = jwtTokenProvider.resolveToken(request); // Token'ı al
        Long userId = jwtTokenProvider.getUserIdFromToken(token); // Token'dan kullanıcı ID'sini al
